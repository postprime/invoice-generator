...
type Options struct {
	...
	TextNumberTitle string `default:"請求No" json:"text_version_title,omitempty"`
	...
	TextConsumptionTaxTotal  string `default:"使用料に対する消費税額" json:"text_consumption_tax_total,omitempty"`
